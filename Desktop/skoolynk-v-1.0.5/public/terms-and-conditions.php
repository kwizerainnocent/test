...
<html>
	<head>
		...
		<title>skoolynk privacy policy</title>
		<link rel="shortcut icon" href="images/title.png"/><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<style> 
			#body{ font-family: "Times New Rowan", Times, serif; font-size:16px;}
			#bigdiv{margin:15px auto;}
			h1{color:#286090; font-weight:bold; }
			h4{font-weight:bold; padding:8px; color:white; background:#286090; }
			#privacy{margin-top:50px; background:#fff; margin}
			#link{color:blue;}
			b{color:blue;}
		</style>
	</head>
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <form class="navbar-form navbar-left" autocomplete="off" role="search" >
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="signup.php" id="top-link"><button class="btn btn-default" style="font-size:12px; font-weight:bold; color:purple;border-radius:2px; margin:0px; padding-top:7px; line-height:7px;">Create account</button></a></li>
				<li><a href="admin-home.php" id="top-link"><button class="btn btn-primary" style="font-size:12px; border-radius:2px; margin:0px; padding-top:7px; line-height:7px;">Sign in</button></a></li>
			</ul>
	   </div>
	   </div>
	</nav>
...
<div class="container" id="privacy">
		<div id="bigdiv">
			...
			<hr/>
			<p>These terms and conditions outline the rules and regulations for the use of skoolynk's Website. 
              <br/>Skoolynk is located at:<br/></p>
			<p><i class="fa fa-map-marker"></i> <b>Makerere, kampala 256 Uganda</b></p>
			<p>
				By accessing this website we assume you accept these terms and conditions in full. 
				Do not continue to use skoolynk's website if you do not accept all of the terms and conditions stated on this page.
			</p>
			<p>
				The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", “You” and “Your” refers to you, the person accessing this website and 
				...
				All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration, or any 
				other means, for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services/products, in accordance with and subject to, prevailing law of Uganda. Any use of the above terminology 
				or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.
			</p>
		</div>
		...
		<div id="bigdiv">
			<h4>Cookies</h4>
			<p>
				We employ the use of cookies. By using skoolynk's website you consent to the use of cookies in accordance with skoolynk’s privacy policy.
			</p>
			<p>
		...
		<div id="bigdiv">
			<h4>License</h4>
			<p>
				Unless otherwise stated, skoolynk and/or it’s licensors own the intellectual property rights for all material on skoolynk All intellectual property rights are reserved. 
				You may view and/or print pages from http://www.skoolynk.com for your own personal use subject to restrictions set in these terms and conditions.
			</p>
			<p>You must not:</p>
			<ul>
			<li>Republish material from http://www.skoolynk.com</li>
			<li>Sell, rent or sub-license material from http://www.skoolynk.com</li>
			<li>Reproduce, duplicate or copy material from http://www.skoolynk.com</li>
			</ul>
			<p>Redistribute content from skoolynk (unless content is specifically made for redistribution).</p>
		</div>		
		...
		<div id="bigdiv">
			...
			<ol>
				...
				<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. skoolynk does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of skoolynk, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws skoolynk shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
				<li>skoolynk reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
				<li>You warrant and represent that:
					<ol>
						...
						<li>You hereby grant to skoolynk a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
					</ol>
				</li>
			</ol>
		</div>	
		...
		<div id="bigdiv">
			...
			<p>
				...
				(c) the benefit to us from the visibility associated with the hyperlink outweighs the absence of skoolynk; and 
			...
			<p>
				If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <b>kigh143 at gmail.com.</b> 
				Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site,
				a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.
			</p>
